...
\hline
{\ul \textbf{Models/Feature Extraction}} & \textbf{Bag of Words} & \textbf{TF-IDF} & \textbf{Word Embeddings} \\ \hline
\textbf{Boosted Trees(Catboost)}         & 56.180                & 55.569          & 28.900                   \\ \hline
\textbf{Support Vector Machines}         & 59.354                & 61.470          & 29.291                   \\ \hline
\textbf{Neural Networks}                 & 58.797                & 59.580          & 33.852                   \\ \hline
\end{tabular}
\end{table}$$
...
In Figure XXX we see the word embeddnigs SVM confusion matrix: Ghe model upon inivestigation here has failed greatly. It has simiply predicted all sentencees belonging to Ramaphosa and hence cannot be interpretted at any meaningful level 
```{python}
#| echo: false
#| eval: false
